...
if 1:
    ...
    # Dataset.
    desc += '-fvector';  dataset = EasyDict(tfrecord_dir='C:/Users/conno/Documents/GitHub/stylegan/datasets/fvector/fvectortf', resolution=512); train.mirror_augment = True
...
if 0:
    ...
    # Dataset (choose one).
    desc += '-fvector';  dataset = EasyDict(tfrecord_dir='./datasets/fvector/fvectortf', resolution=512); train.mirror_augment = True
    #desc += '-celebahq';            dataset = EasyDict(tfrecord_dir='celebahq'); train.mirror_augment = True
