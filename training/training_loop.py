...
def training_loop(
    ...
    resume_run_id           = "./models/network-snapshot-007270.pkl",     # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 7270.0,      # Assumed training progress at the beginning. Affects reporting and training schedule.
